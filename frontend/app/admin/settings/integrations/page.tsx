...
{var head=doc.head||doc.getElementsByTagName("head")[0],script=doc.createElement("script");script.setAttribute("type","text/javascript"),script.setAttribute("src","https://Abhinav-CHD.in/ai-chatbot-framework/app/static/widget/script.js"),head.appendChild(script)}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Copy and paste the below snippet into your HTML code (below body
              tag) to add the chat widget to your website.
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="text-sm text-gray-600">
                    Add any context you want to pass to the chat such as
                    username, email, etc. This can be accessed from intents and
                    can be used to personalize the chat experience.
                  </span>
                </div>
              </div>
            </div>
